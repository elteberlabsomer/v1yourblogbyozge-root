...
export type SocialMediaCardVariant = 'twitter' | 'reddit';

type SocialMediaCardProps = {
  variant: SocialMediaCardVariant;
  href: string;
  handle: string;
  subtitle: string;
  avatarSrc: string;
...
export function SocialMediaCard({
  ...
  const variantClass = variant === 'twitter' ? styles.twitterCard : styles.redditCard;
  const platformMark =
    variant === 'twitter' ? (
  ...
  return (
    ...
    >
      ...
      <div className={styles.footer}>
        {platformMark}
        <span className={styles.followBtn} aria-hidden="true">
          {ctaLabel}
        </span>
      </div>
    </a>
